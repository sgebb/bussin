...
// ============================================================================
// BACKGROUND MESSAGE SEARCH (with filters)
// ============================================================================
...
type SearchProgressCallback = (scanned: number, matches: number, newMatches: number[]) => void;

/**
 * Search for messages in a queue matching filters
 */
async function searchQueueMessages(
    namespace: string,
    queueName: string,
    token: string,
 ...
 */
async function searchSubscriptionMessages(
    namespace: string,
    topicName: string,
    subscriptionName: string,
    token: string,
 ...
 */
async function peekQueueMessagesBySequence(
    namespace: string,
    queueName: string,
    token: string,
    sequenceNumbers: number[],
 ...
 */
async function peekSubscriptionMessagesBySequence(
    namespace: string,
    topicName: string,
    subscriptionName: string,
    token: string,

...
public interface IServiceBusJsInteropService
{
    ...
    Task<IJSObjectReference> PurgeQueueAsync(string namespaceName, string queueName, string token);
    ...
    Task<IJSObjectReference> PurgeSubscriptionAsync(string namespaceName, string topicName, string subscriptionName, string token);
